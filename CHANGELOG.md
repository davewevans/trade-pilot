...
### Removed
- **Short Strangle strategy** — removed and replaced by Iron Butterfly. Alpaca's Level 3 mleg
  rules reject orders with two uncovered sell-to-open legs, making the strangle's entry
  non-atomic with unacceptable partial-fill risk.
