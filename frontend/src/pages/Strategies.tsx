  ...
  return (
    <div ref={contentRef} className="max-w-5xl">
      ...
      >
        ...
        <Subheading>When the bot sells assigned shares at a loss</Subheading>
        <Prose>
          The Turnover Wheel uses the same exit triggers as the Standard Wheel — these rules are deliberately
          shared so that performance differences between the two accounts reflect CC-selection philosophy,
          not different loss-cutting behavior.
        </Prose>
        <ul className="space-y-1.5 text-sm" style={{ color: 'var(--text-secondary)' }}>
          <li className="flex gap-2"><span style={{ color: 'var(--red, #ef4444)' }}>•</span> Stock drops &gt; 25% below cost basis AND is more than 2% below the 200-day SMA → sell shares</li>
          <li className="flex gap-2"><span style={{ color: 'var(--red, #ef4444)' }}>•</span> Stock drops &gt; 15% below cost basis with two or more downgrades from major Wall Street firms in the past 30 days → sell shares</li>
